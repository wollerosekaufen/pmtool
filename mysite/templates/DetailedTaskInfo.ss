...
<div class="content-container unit size3of4 lastUnit">
	...
	<div class="pure-u-1-4">
        ...
        <% if $ActiveProject %>
                        ...
                        <% if $Tasks %>
                            ...
                            <table class="pure-table">
                                ...
                                <tbody>
                                    <% loop $Tasks %>
                                    <tr>
                                        <td><a href="projectmanager/$Project.ID/tasks/$ID">$Title</a></td>
            ...
            <% end_with %>
        <% else %>
            <p style="margin: 6px 20px;">Kein Projekt ausgew&auml;hlt.</p>
        <% end_if %>
		
		<!-- Bei Klick auf Task Info einfügen -->
		<% with $Task %>
			<br>
			<h5>$Title</h5>
			<ul>
				<li>ID: $ID</li>
				<li>Created: $Created.Nice</li>
				<li>Last edited: $LastEdited.Nice</li>
				<li>Estimated time: $EstimatedTime h</li>
				<li>Description: $Description.LimitWordCount(10)</li>
			</ul>
		<% end_with %>
